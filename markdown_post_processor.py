...
class MarkdownPostProcessor:
    ...
    def process_file(self, input_path: Path, output_path: Path | None = None) -> Path:
    ...
    def should_merge_with_previous(self, prev_line: str, current_line: str) -> bool:
        ...
        return bool(not re.search(r'[.!?:;]$', prev_line.rstrip()) and not self.is_special_line(current_line))
    ...
    def fix_split_formatting(self, prev_line: str, current_line: str) -> str | None:
        ...
        if re.search(r'\*\*[^*]+$', prev_line) and not current_line.startswith('**') and '**' in current_line:
